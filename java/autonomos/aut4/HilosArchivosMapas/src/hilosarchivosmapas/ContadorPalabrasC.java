...
public class ContadorPalabrasC {
    ...
    public static void main(String... args) {
        var c = new ContadorPalabrasC();
        for (var ignored : archivos) { new Thread(c::generarReportes).start(); }
        ...
        for (var arc : archivos) {
            try (var bW = new BufferedWriter(
                ...
                for (var clave : hM.keySet()) {
                    /* escribe las claves y valores en formato especificado */
